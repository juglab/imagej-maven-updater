...
public interface VersioningService {
	 ...
	 * The differences to {@link #commitCurrentChanges()} is that
	 * this one will commit even if there are no changes
	 * @throws Exception
	 */
	void forceCommitCurrentChanges() throws IOException, GitAPIException;
	...
	VersioningUIService getUI();

	Session getSession(String name) throws GitAPIException, IOException;
}
